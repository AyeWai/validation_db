...
--Création de tous les produits vendus dans la tale product
...
insert into products(id, name, description, create_date, price, img) values(1, "Diamant 5.50ct", "Diamant blabla" , CURRENT_TIMESTAMP(), 10794,00, "https://cdn.pixabay.com/photo/2016/02/14/09/45/precious-1199183_960_720.jpg");
